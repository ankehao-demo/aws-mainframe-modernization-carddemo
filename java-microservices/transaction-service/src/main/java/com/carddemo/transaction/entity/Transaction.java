...
/**
 * Transaction entity - from copybook CVTRA05Y.cpy (350-byte records).
 * Dataset: AWS.M2.CARDDEMO.TRANSACT.VSAM.KSDS
 */
@Entity
@Table(name = "transactions", indexes = {
    @Index(name = "idx_tran_card", columnList = "card_number"),
    @Index(name = "idx_tran_account", columnList = "account_id")
})
