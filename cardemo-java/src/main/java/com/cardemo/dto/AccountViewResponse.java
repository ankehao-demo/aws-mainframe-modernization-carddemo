...
/**
 * DTO combining account + customer data for the Account View endpoint.
 * Derived from COACTVWC.cbl lines 471-523, which joins data from
 * CXACAIX (cross-reference), ACCTDAT (account master), and CUSTDAT (customer master).
 */
public class AccountViewResponse {

    // Account fields (from ACCTDAT / CVACT01Y.cpy)
    ...
    // Customer fields (from CUSTDAT / CVCUS01Y.cpy)
