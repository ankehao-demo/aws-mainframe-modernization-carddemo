...
/**
 * Daily transaction input entity derived from CVTRA06Y.cpy (DALYTRAN-RECORD, RECLN 350).
 *
 * COBOL field mappings:
 *   DALYTRAN-ID              PIC X(16)       -> String (primary key)
 *   DALYTRAN-TYPE-CD         PIC X(02)       -> String
 *   DALYTRAN-CAT-CD          PIC 9(04)       -> Integer
 *   DALYTRAN-SOURCE          PIC X(10)       -> String
 *   DALYTRAN-DESC            PIC X(100)      -> String
 *   DALYTRAN-AMT             PIC S9(09)V99   -> BigDecimal
 *   DALYTRAN-MERCHANT-ID     PIC 9(09)       -> Long
 *   DALYTRAN-MERCHANT-NAME   PIC X(50)       -> String
 *   DALYTRAN-MERCHANT-CITY   PIC X(50)       -> String
 *   DALYTRAN-MERCHANT-ZIP    PIC X(10)       -> String
 *   DALYTRAN-CARD-NUM        PIC X(16)       -> String
 *   DALYTRAN-ORIG-TS         PIC X(26)       -> String
 *   DALYTRAN-PROC-TS         PIC X(26)       -> String
 */
@Entity
